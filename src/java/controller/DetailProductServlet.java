...
//        processRequest(request, response);
        ...
        String idP_raw = request.getParameter("product");
        String getProductCID_pare = request.getParameter("cid");
        ...
        try {
            if (idP_raw != null && !idP_raw.isEmpty()
                    && getProductCID_pare != null
                    && !getProductCID_pare.isEmpty()) {
                idP = Integer.parseInt(idP_raw);
                getProductCID = Integer.parseInt(getProductCID_pare);
